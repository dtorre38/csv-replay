...
int main(int argc, const char** argv) {
  ...
  if (argc < 3) {
      std::cerr << "Usage: ./simulate <model_path> <data_file>" << std::endl;
      return 1;
  }

  // argv[2] is the data file path, updating the global variable
  strncpy(data_file, argv[2], sizeof(data_file) - 1);
